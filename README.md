...
[![Status](https://img.shields.io/badge/Status-Prot%C3%B3tipo_+_MVP_funcional-3DD9C7?style=flat)](#-status-do-projeto)
...
Este repositório faz parte do **Trabalho de Conclusão de Curso** do Bacharelado em **Sistemas de Informação** da **UFVJM**. O TCC é uma **revisão bibliográfica** sobre o uso de gamificação como ferramenta de conscientização em segurança da informação, com proposta concreta materializada em um **protótipo de alta fidelidade**.

A entrega formal exigida pelo TCC é o **protótipo no Figma** (linkado acima). Este repositório vai além: contém um **MVP funcional** implementado em cima do protótipo, **com o objetivo explícito de facilitar o trabalho de pesquisadores futuros** que queiram dar continuidade à proposta — seja em outro TCC, mestrado, doutorado ou desenvolvimento como produto real.

**Por que entregar um MVP além do protótipo?** Porque um app navegável real reduz drasticamente a barreira de entrada para quem pegar este trabalho. Em vez de receber apenas mockups estáticos, o próximo pesquisador encontra: arquitetura definida, fluxos navegáveis, modelo de dados implementado e código de referência funcionando.

## 📌 Status do projeto

| Entrega | Status | Onde ver |
|---|---|---|
| **Protótipo de alta fidelidade (Figma)** — entrega formal do TCC | ✅ Concluído | [Link do Figma](https://www.figma.com/design/31mshRyEJ3thfybxoS4uLh/Securio---O-CyberQuiz?node-id=0-1) |
| **Revisão bibliográfica e proposta** — entrega formal do TCC | ✅ Concluído | Texto do TCC |
| **MVP funcional** — entrega extra para apoiar trabalhos futuros | ✅ Concluído | Este repositório / [demo](https://securio-woad.vercel.app) |
| **Produto pronto para uso público** | ⏳ Trabalho futuro | Ver [DOCUMENTACAO.md](DOCUMENTACAO.md#para-quem-for-continuar-este-projeto) |

> ⚠️ Este MVP é um **protótipo funcional para demonstração e base de continuidade** — não está pronto para uso em produção. Pendências completas estão catalogadas na [documentação técnica](DOCUMENTACAO.md#para-quem-for-continuar-este-projeto).
...
- Arquitetura e modelo de dados do MVP
...
- 10 sugestões de **trabalhos futuros de pesquisa** que podem se apoiar neste MVP
...
- **Anthropic** — o desenvolvimento do MVP funcional e desta documentação foi realizado em sessões intensivas de pair programming com **Claude (Opus 4.7)** via Claude Code, no plano Max 5x. Detalhes em [DOCUMENTACAO.md](DOCUMENTACAO.md#processo-de-desenvolvimento-com-ia-assistente).
